...
declare let FXInitialized: boolean;
declare let analysisInitialized: boolean;
...
declare const EQBandControl1: HTMLInputElement;
declare const EQBandControl2: HTMLInputElement;
declare const EQBandControl3: HTMLInputElement;
declare const EQCutoffControl1: HTMLInputElement;
declare const EQCutoffControl2: HTMLInputElement;
declare const EQQControl: HTMLInputElement;
...
declare function initAnalysis(): void;
...
declare function setupDDL(input: AudioNode): AudioNode;
declare function setupEQ(input: AudioNode, b1: number, b2: number, b3: number, cutoff1: number, cutoff2: number, Q: number): AudioNode;

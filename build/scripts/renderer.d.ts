...
declare const DDLDryControl: HTMLInputElement;
declare const DDLWetControl: HTMLInputElement;
declare const DDLFeedControl: HTMLInputElement;
declare const DDLTimeControl: HTMLInputElement;
...
declare function setupDDL(input: AudioNode, dryLevel: number, wetLevel: number, feedLevel: number, timeLevel: number): AudioNode;
